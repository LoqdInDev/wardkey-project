...
AUTOFILL & SAVE
Automatically detect login forms and fill credentials with one click. WARDKEY prompts to save new passwords as you sign up for sites.
...
TRAVEL MODE
Hide sensitive vault items when crossing borders. One toggle, instant protection.

IMPORT EVERYTHING
One-click import from LastPass, 1Password, Bitwarden, Chrome, and generic CSV/JSON files.

DARK & LIGHT MODE
Beautiful interface in both themes, matching your system preference.
...
Ctrl+Shift+L — Open WARDKEY
Ctrl+Shift+G — Generate password

--- PERMISSIONS ---

WARDKEY requests minimal permissions:
...
Website: https://wardkey.io
Privacy Policy: https://wardkey.io/privacy
Terms of Service: https://wardkey.io/terms
Security: https://wardkey.io/security
